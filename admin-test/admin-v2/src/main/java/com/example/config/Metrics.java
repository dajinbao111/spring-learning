...
public enum Metrics {
    ...
    JVM_MEMORY_MAX("jvm.memory.max", "The maximum amount of memory in bytes that can be used for memory management", true),
    JVM_MEMORY_USED("jvm.memory.used", "The amount of used memory", true),
    JVM_MEMORY_COMMITTED("jvm.memory.committed", "The amount of memory in bytes that is committed for the Java virtual machine to use", true),
    ...
    JVM_THREADS_DAEMON("jvm.threads.daemon", "The current number of live daemon threads", true),
    JVM_THREADS_LIVE("jvm.threads.live", "The current number of live threads including both daemon and non-daemon threads", true),
    JVM_THREADS_PEAK("jvm.threads.peak", "The peak live thread count since the Java virtual machine started or peak was reset", true),
    ...
    JVM_THREADS_STATES("jvm.threads.states", "The current number of threads having ${state} state", true),
